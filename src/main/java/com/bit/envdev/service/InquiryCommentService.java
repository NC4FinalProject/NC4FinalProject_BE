...
public interface InquiryCommentService {
    ...
    List<InquiryCommentDTO> delete(long inquiryCommentId, CustomUserDetails customUserDetails);

    List<InquiryCommentDTO> getInquiryCommentList(int inquiryCommentId);
}
